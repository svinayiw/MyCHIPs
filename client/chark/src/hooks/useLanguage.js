...
import {languageSlice} from '../redux/reducers/languageSlices';
...
function addTextsToState(field, texts, setState) {
  setState(prev => {
    ...
    store.dispatch(languageSlice.actions.saveLanguages(newLanguage));
